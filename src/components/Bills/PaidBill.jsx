            ...
            <div className='flex-1 bg-gray-100 flex flex-col'>
                ...
                <div className="container mx-auto p-2">
                    ...
                    <div className="flex mb-4 p-4">
                        <Link to="/bills" className="text-gray-500 py-2 px-4 rounded text-lg" >Unpaid Bill</Link>
                        <Link to="/paidbill" className="text-gray-500 py-2 px-4 rounded" style={{ color: "#00bfff", borderBottom: "5px solid #00bfff" }}>Paid Bills</Link>
                    </div>
                            ...
                            {bills.map(bill => (
                                <div key={bill.id} className="border p-4 rounded-lg shadow-md bg-white">
                                    ...
                                    <div className="flex justify-between mt-2">
                                        ...
                                        <div className="text-gray-900 font-bold text-green-600">{bill.totalAmount}</div>
                                    </div>
