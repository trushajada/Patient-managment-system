...
const Prescriptions = () => {
    ...
    const doctorsData = [
        { name: "Dr. Ryan Vetrov", hospital: "Artemis Hospital", disease: "Viral Infection", date: "2 Jan, 2022" },
        { name: "Dr. Omar Herwitz", hospital: "Artemis Hospital", disease: "Viral Infection", date: "2 Jan, 2022" },
        { name: "Dr. Corey Dorwart", hospital: "Artemis Hospital", disease: "Viral Infection", date: "2 Jan, 2022" },
        { name: "Dr. Kadin Workman", hospital: "Artemis Hospital", disease: "Viral Infection", date: "2 Jan, 2022" },
        { name: "Dr. Leo Workman", hospital: "Artemis Hospital", disease: "Viral Infection", date: "2 Jan, 2022" },
        { name: "Dr. Emerson Levin", hospital: "Artemis Hospital", disease: "Viral Infection", date: "2 Jan, 2022" },
        { name: "Dr. Emerson Press", hospital: "Artemis Hospital", disease: "Viral Infection", date: "2 Jan, 2022" },
        { name: "Dr. Phillip Rhiel Madsen", hospital: "Artemis Hospital", disease: "Viral Infection", date: "2 Jan, 2022" },
        { name: "Dr. Jaylon Lubin", hospital: "Artemis Hospital", disease: "Viral Infection", date: "2 Jan, 2022" },
        { name: "Dr. Ruben Septimus", hospital: "Artemis Hospital", disease: "Viral Infection", date: "2 Jan, 2022" },
        { name: "Zaire Dorwart", hospital: "Artemis Hospital", disease: "Viral Infection", date: "2 Jan, 2022" },
    ];
    ...
    const handleEyeClick = (doctor) => {
        ...
        navigate(`/download`, { state: { doctor } });
    };
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        {filteredDoctors.map((doctor, index) => (
                            <div key={index} className="bg-white p-4 rounded shadow mb-4">
                                ...
                                <p className="text-gray-600 ms-3">Hospital Name: {doctor.hospital}</p>
                                <p className="text-gray-600 ms-3">Disease Name: {doctor.disease}</p>
                                <p className="text-gray-600 ms-3">Date: {doctor.date}</p>
                            </div>
                        ))}
