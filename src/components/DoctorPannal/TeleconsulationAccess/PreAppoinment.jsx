        ...
        <div className="bg-gray-100 min-h-screen flex">
            ...
            <div className="flex-1 bg-gray-100 flex flex-col">
                <div className="flex items-center justify-between p-4 h-24 mb-6 bg-white">
                    <div className="flex items-center">
                        ...
                        <span style={{ color: "#00bfff " }} className='font-semibold'>
                            {menuItems.find(item => item.path === location.pathname)?.name || 'Teleconslution module'}
                        </span>
                    </div>
                ...
                <div className="flex mb-4 p-4">
                    <Link to="/module" className="text-gray-500 py-2 px-4 rounded" >Scheduled Appointments</Link>
                    <Link to="/Previousappo" className="text-gray-500 py-2 px-4 rounded" style={{ color: "#00bfff", borderBottom: "5px solid #00bfff" }}>Previous Appointments</Link>
                                ...
                                >
                                    ...
                                    <div className="text-sm text-gray-600">
                                        <div className="flex justify-between">
                                            <span className="font-semibold text-gray-400 mb-1">Appointment Type</span>
                                            <span className={`font-bold ${appointment.type === "Online" ? "text-yellow-400" : "text-blue-600"}`}>
                                                {appointment.type}
                                            </span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span className="font-semibold text-gray-400 mb-1">Hospital Name:</span>
                                            <span className='font-semibold'>{appointment.hospital}</span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span className="font-semibold text-gray-400 mb-1">Appointment Date:</span>
                                            <span className='font-semibold'>{appointment.date}</span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span className="font-semibold text-gray-400 mb-1">Appointment Time:</span>
                                            <span className='font-semibold'>{appointment.time}</span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span className="font-semibold text-gray-400 mb-1">Patient Issue:</span>
