...
const appointmentsData = [
    {
        ...
        time: "10:20 AM",
        issue: "Feeling Tired",
        AppoinmentCancleDate :"5 Feb ,2022"
    },
    {
        id: 2,
        ...
        <div className="bg-gray-100 min-h-screen flex">
            ...
            <div className="flex-1 bg-gray-100 flex flex-col">
                ...
                <div className="flex mb-4 p-4">
                    ...
                    <Link to="/Cancleappo" className="text-gray-500 py-2 px-4 rounded" style={{ color: "#00bfff", borderBottom: "5px solid #00bfff" }}>Cancle Appointments</Link>
                            ...
                            {filteredAppointments.map((appointment) => (
                                ...
                                >
                                    ...
                                    <div className="text-sm text-gray-600">
                                        ...
                                        <div className="flex justify-between mb-1">
                                            <span className="font-semibold text-gray-400">Appointment Cancle Date:</span>
                                            <span className='font-semibold'>{appointment.AppoinmentCancleDate}</span>
                                        </div>
                                        <div className="flex justify-between mb-1">
