...
const PenddingAppoinment = () => {
    ...
    const handleNavigateToReschedule = (appointmentId) => {
        navigate(`/residual-timeslot`);
    };
        ...
        <div className="bg-gray-100 min-h-screen flex">
            ...
            <div className="flex-1 bg-gray-100 flex flex-col">
                ...
                <div className="flex mb-4 p-4">
                    ...
                    <Link to="/pendding" className="text-gray-500 py-2 px-4 rounded" style={{ color: "#00bfff", borderBottom: "5px solid #00bfff" }}>Pendding Appointments</Link>
                            ...
                            {filteredAppointments.map((appointment) => (
                                ...
                                >
                                    ...
                                    <div className="mt-4 flex justify-between">
                                        ...
                                        <button
                                            onClick={() => handleNavigateToReschedule(appointment.id)}
                                            className="bg-[#00bfff] text-white px-3 py-1 rounded-lg flex items-center space-x-2"
                                        >
                                            <BsFillCalendarEventFill />
...
export default PenddingAppoinment;
