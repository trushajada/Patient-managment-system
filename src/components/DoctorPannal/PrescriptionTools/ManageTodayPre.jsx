...
const ManageTodayPre = () => {
    ...
    const filteredpatientstoday = patientstoday.filter(patientstoday =>
        patientstoday.name.toLowerCase().includes(searchTerm.toLowerCase())
    );
    ...
    return (
        <div className="bg-gray-100 min-h-screen flex">
            ...
            <div className="flex-1  flex flex-col">
                ...
                <div className="flex mb-4 p-4">
                        <Link to="/manage" className="text-gray-500 py-2 px-4 rounded" style={{ color: "#00bfff", borderBottom: "5px solid #00bfff" }}>Today Prescription</Link>
                        <Link to="/older" className="text-gray-500 py-2 px-4 rounded" >Older Prescription</Link>
                    </div>
                <div className="flex-1  flex flex-col p-4">
                    <div className="bg-white shadow-lg p-6 rounded-lg">
                        ...
                        <div className="p-4 pr-8 bg-white">
        ...
        <tbody>
            {filteredpatientstoday.map((patientstoday, index) => (
                <tr key={index} className='border-b border-gray-300 mt-4'>
                    <td className="py-3 px-6 text-left">{patientstoday.name}</td>
                    <td className="py-3 px-6 text-left">{patientstoday.number}</td>
                    <td className="py-3 px-6 text-left">{patientstoday.type}</td>
                    <td className="py-3 px-6 text-left">{patientstoday.time}</td>
                    <td className="py-3 px-6 text-left">{patientstoday.age}</td>
                    <td className="py-3 px-6 text-left">{patientstoday.gender}</td>
