...
const Paymethoddetail = () => {
    ...
    const handleSubmit = (e) => {
        ...
        navigate('/Apposucssess', { state: paymentData });
    };
    ...
    return (
        <div className="relative min-h-screen flex items-center justify-center bg-cover bg-center" style={{ backgroundImage: `url(${Todaypage})` }}>
            {/* Overlay */}
...
export default Paymethoddetail;
