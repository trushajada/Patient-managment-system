    ...
    <div className="bg-gray-100 min-h-screen flex">
      ...
      <div className="flex-1 bg-gray-100 flex flex-col">
        ...
        <div className="flex mb-4 p-4">
                        ...
                        <Link to="/upcoming" className="text-gray-500 py-2 px-4 rounded"   >Upcoming Appointments</Link>
                        <Link to="/Previous" className="text-gray-500 py-2 px-4 rounded"  style={{ color: "#00bfff", borderBottom: "5px solid #00bfff" }} >Previous Appointments</Link>
                        <Link to="/Cancle" className="text-gray-500 py-2 px-4 rounded"   >Cancle Appointments</Link>
                    </div>
                    <div className="flex-1  flex flex-col p-4">
                    <div className="bg-white shadow-lg p-6 rounded-lg">
                        <div className="flex justify-between items-center mb-4">
            <h1 className="text-2xl font-semibold">Previous Appointments</h1>
...
export default PreviousAppoinment;
